...
CreamProxy_Resume::CreamProxy_Resume( const JobFilterWrapper* filter, 
...
//______________________________________________________________________________
void CreamProxy_Resume::execute( const string& serviceAddress, const bool ignore_tag_mismatch ) 
  throw(BaseException&,
...
#ifdef DOPROFILE
    apiUtil::scoped_timer T("CreamProxy_Resume::execute-soap_call___CREAM__JobResume");
#endif  
    
    if(SOAP_OK != soap_call___CREAM__JobResume(m_soap,
