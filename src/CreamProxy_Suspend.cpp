...
CreamProxy_Suspend::CreamProxy_Suspend( const JobFilterWrapper* filter, 
...
//______________________________________________________________________________
void CreamProxy_Suspend::execute( const string& serviceAddress, const bool ignore_tag_mismatch ) 
  throw(BaseException&,
...
#ifdef DOPROFILE
    apiUtil::scoped_timer T("CreamProxy_Suspend::execute-soap_call___CREAM__JobSuspend");
#endif  
    
    if(SOAP_OK != soap_call___CREAM__JobSuspend(m_soap,
