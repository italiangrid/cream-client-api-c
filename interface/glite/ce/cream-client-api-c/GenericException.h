...
END LICENSE */
#ifndef _GLITE_CE_CREAM_CLIENT_API_CREAMEX_GENERICEX_H_
#define _GLITE_CE_CREAM_CLIENT_API_CREAMEX_GENERICEX_H_
...
namespace glite {
  namespace ce {
	...
	/** An object of this class is raised as an exception when the remote 
	  CREAM Web Service sends back to the client a GenericFault
	 */
	class GenericException : public BaseException {
	  
	public:
	  GenericException(const std::string& mn,
			   const std::string& ec,
