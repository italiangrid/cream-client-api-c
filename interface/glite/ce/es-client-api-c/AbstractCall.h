...
// 	};
	...
	int                     m_soap_timeout;
	std::string             m_soap_buffer;

      protected:
	struct soap*            m_SOAP;
	std::string             m_endpoint;
	void                    save_soap_buffer( );
	...
	std::string get_soap_buffer( ) const { return m_soap_buffer; }

	bool init( const std::string&,
		   const std::string&,
		   std::string& error );

	static void get_string_error( std::string&, const wrapper::WInternalBaseFault& );
...
// 	virtual void   getResponse( std::map<std::string, wrapper::WActivityStatus>& states,
// 				    std::map<std::string, wrapper::WInternalBaseFault>& faults ) const {}
// 
...
// 				    std::map<std::string, wrapper::WInternalBaseFault>& failed ) const {}
// 
// 	virtual void   getResponse( std::vector<std::pair<std::string, wrapper::WInternalBaseFault> >& ) const {}
// 
// 	virtual void   getResponse( std::vector<boost::tuple<std::string, std::string, std::string> >& ) const {}
	
      protected:
	static void get_string_error( std::string&, InternalBaseFault* );
